...
def train_model(model, criterin, optimizer, scheduler, num_epochs):
    ...
    torch.save(best_models_wts, os.path.join('../weight_finetuning_path/weight_finetuning_path_densenet161_trans_top5', model_path))
    print()
...
plt.savefig(os.path.join("../graph/densenet161_trans_top5", graph))
