...
#読み取る画像ディレクトリ指定
#data_dir = '/mnt/data1/kikuchi/kikuchisan/valval/train2'
...
def train_model(model, criterin, optimizer, scheduler, num_epochs):
    ...
    torch.save(best_models_wts, os.path.join('../weight_finetuning_path/weight_finetuning_path_densenet121', model_path))
    print()
